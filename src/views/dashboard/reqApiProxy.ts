...
export function getlimitBoard(chooseData) {
  const reqConfig = {
    url: '/gp/call_auction_v2/stock_chance/v1/history_list/limit_board',
    // baseURL: '',
    method: 'post',
    //reqLoading: false,
...
export function getCallWarn(date) {
  const reqConfig = {
    url: '/gp/call_auction_v2/stock_chance/v1/history_list/call_warn',
    baseURL: '',
    method: 'post',
    reqLoading: false,
    data: {
...
export function getlimitUp(data) {
  const reqConfig = {
    url: `/gp/dataapi/limit_up/limit_up?page=1&limit=30&field=199112%2C10%2C48%2C1968584%2C19%2C3475914%2C9003%2C9004&filter=HS%2CGEM2STAR&order_field=199112&order_type=0&date=${data}`,
    baseURL: '',
    method: 'post'
  }
  return axiosReq(reqConfig)
...
export function getLimitUpPool() {
  const reqConfig = {
    url: `/gp/dataapi/limit_up/limit_up_pool?page=1&limit=15&field=601211%2C330329%2C9001%2C330324%2C10%2C199112%2C330325%2C9002%2C133971%2C133970%2C1968584%2C3475914%2C9003%2C9004&filter=HS%2CGEM2STAR&order_field=330324&order_type=0&date=20241011`,
    method: 'post'
  }
